    ...
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-pink-500/20 mb-4">
            <Lightbulb className="w-8 h-8 text-pink-400" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">💡 Money-Making Ideas</h1>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Discover proven side hustles and earning strategies that actually work.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="relative">
            ...
            <input
              ...
              name="search"
              type="text"
              placeholder="Search money-making ideas..."
              value={search}
        ...
        {loading ? (
          ...
          <div className="text-center py-20 glass-effect rounded-2xl">
            <p className="text-xl text-gray-400 mb-4">No ideas found.</p>
